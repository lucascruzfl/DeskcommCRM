  ...
  public: {
    Tables: {
      ...
      ai_agent_assignable_directory: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_agent_assignable_directory_agent_id_fkey";
            columns: ["agent_id"];
            isOneToOne: true;
            referencedRelation: "ai_agents";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "ai_agent_assignable_directory_organization_id_fkey";
            columns: ["organization_id"];
            isOneToOne: false;
            referencedRelation: "operational_organizations";
            referencedColumns: ["id"];
      ...
      calendar_appointments: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["google_connection_id"];
            isOneToOne: false;
            referencedRelation: "operational_calendar_connections";
            referencedColumns: ["id"];
          },
          {
      ...
      campaigns: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["organization_id", "pipeline_id"];
            isOneToOne: false;
            referencedRelation: "operational_crm_pipelines";
            referencedColumns: ["organization_id", "id"];
          },
          {
      ...
      managed_client_policies: {
        ...
        Relationships: [
          {
            foreignKeyName: "managed_client_policies_organization_id_fkey";
            columns: ["organization_id"];
            isOneToOne: true;
            referencedRelation: "operational_organizations";
            referencedColumns: ["id"];
      ...
      operational_inbox_signals: {
        ...
        Relationships: [
          {
            foreignKeyName: "operational_inbox_signals_conversation_id_fkey";
            columns: ["conversation_id"];
            isOneToOne: true;
            referencedRelation: "conversations";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "operational_inbox_signals_organization_id_fkey";
            columns: ["organization_id"];
            isOneToOne: false;
            referencedRelation: "operational_organizations";
            referencedColumns: ["id"];
