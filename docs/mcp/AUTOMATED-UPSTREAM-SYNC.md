...
classificação A/B/C exige revisão humana quando a semântica mudou. A release
MCP continua fechada enquanto `RELEASE-AUDIT.json` não identificar a versão e
